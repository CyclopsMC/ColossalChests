...
public class BlockEntityColossalChestConfigFabric<M extends ModBaseFabric> extends BlockEntityColossalChestConfig<M> {
    ...
    public void onRegistryRegistered() {
        ...
        // If this would cause performance issues, we could implement a custom Storage instead of ContainerStorage that makes better use of Storage's capabilities.
